...
from .models import Chofer  # Asegúrate de importar tu modelo correctamente

class RegistroForm(forms.ModelForm):
    class Meta:
        model = Chofer
        fields = [
            'Legajo', 'nombre', 'apellido', 'dni', 'calle', 'nrocalle',
        ...
        widgets = {
            ...
            'nrocalle': forms.TextInput(attrs={
            ...
            'contactoemergencia': forms.TextInput(attrs={
            ...
            'ingresoFCA_venc': forms.DateInput(attrs={
                'type': 'date',
                'class': 'form-control',
            }),
            'licencia_venc': forms.DateInput(attrs={
                'type': 'date',
                'class': 'form-control',
            }),
            'psicofisico_venc': forms.DateInput(attrs={
                'type': 'date',
                'class': 'form-control',
            }),
            'curso_venc': forms.DateInput(attrs={
                'type': 'date',
                'class': 'form-control',
            }),
        }